...
'__react_static_root__/src/pages/choose/digital-camera.js': require('__react_static_root__/src/pages/choose/digital-camera.js').default,
'__react_static_root__/src/pages/choose/disc-media.js': require('__react_static_root__/src/pages/choose/disc-media.js').default,
'__react_static_root__/src/pages/choose/fluorescent-light.js': require('__react_static_root__/src/pages/choose/fluorescent-light.js').default,
'__react_static_root__/src/pages/choose/glow-starter.js': require('__react_static_root__/src/pages/choose/glow-starter.js').default,
'__react_static_root__/src/pages/choose/index.js': require('__react_static_root__/src/pages/choose/index.js').default,
'__react_static_root__/src/pages/choose/ink.js': require('__react_static_root__/src/pages/choose/ink.js').default,
'__react_static_root__/src/pages/choose/lan-cable.js': require('__react_static_root__/src/pages/choose/lan-cable.js').default,
'__react_static_root__/src/pages/choose/network.js': require('__react_static_root__/src/pages/choose/network.js').default,
'__react_static_root__/src/pages/choose/phone.js': require('__react_static_root__/src/pages/choose/phone.js').default,
